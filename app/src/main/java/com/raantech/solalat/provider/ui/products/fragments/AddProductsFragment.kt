                ...
                if (binding?.checkboxIsAvailable?.isChecked == false) {
                    DateDialog(requireActivity(), this, object : DateDialog.CallBack {
                        override fun callBack(date: String) {
                            viewModel.availableDate.postValue(date)
                            checkIban()
                        }
                    }).show()
                } else {
        ...
        return CustomObserverResponse(
                ...
                object : CustomObserverResponse.APICallBack<Any> {
                    override fun onSuccess(
                        ...
                        navigationController.navigate(R.id.action_addProductsFragment_to_accessoryAddedSuccessFragment)
                    }
                }, showError = true
        )
    }
